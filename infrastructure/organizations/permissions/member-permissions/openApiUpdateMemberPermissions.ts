import type { UpdateMemberPermissions } from '../../../../app/sections/organizations/permissions/member-permissions/actions/updateMemberPermissions'
import { createApiClient } from '../../../api/client'
import { getInvalidInputError } from '../../../api/getInvalidInputError'
import { mapMemberPermissionsRequest } from './mapMemberPermissions'
