import type { LoadIssuesMoveStatuses } from '../../../app/sections/issues/issues/actions/loadIssuesMoveStatuses'
import { createApiClient } from '../../api/client'

export const openApiLoadIssuesMoveStatuses = (
  baseUrl: string,
): LoadIssuesMoveStatuses => {
