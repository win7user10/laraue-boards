<template><DataMovementPageApplication :deps="deps" /></template>
...
import DataMovementPageApplication from '~/sections/organizations/data-movement/DataMovementPageApplication.vue'
