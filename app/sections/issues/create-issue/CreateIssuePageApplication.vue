...
import type { CreateIssuePageApplicationDeps } from './CreateIssuePageApplicationDeps'
import CreateIssuePage from './view/CreateIssuePage.vue'

const props = defineProps<{ deps: CreateIssuePageApplicationDeps }>()
...
const { refresh, state: pageState } = await useActionData({
  ...
  key: asyncDataKeys.workspace.createIssue,
  messages: {
