  ...
  <section
    ...
    <div class="title-row">
      <div class="page-heading">
        <SpaceIcon
          ...
          :style="{ color: pageState.data.SpacePage.color }" />
        <div class="page-heading-text">
          <h1>{{ pageState.data.SpacePage.name }}</h1>
        </div>
      </div>
      <div class="title-actions">
        <NuxtLink
          v-if="pageState.data.SpacePage.canManage"
          aria-label="Space settings"
          class="secondary"
          :to="organizationRoutes.spaceSettings(pageState.data.SpacePage.key)">
          <Settings />
          <span class="btn-label">Settings</span>
        </NuxtLink>
        <NuxtLink
          v-if="pageState.data.SpacePage.canCreateBoards"
          class="primary"
          :to="organizationRoutes.newBoard(pageState.data.SpacePage.key)">
          <Plus />
    ...
    <div
      ...
      <NuxtLink
        ...
        :to="organizationRoutes.backlog(pageState.data.SpacePage.key)">
    ...
    <div class="space-section">
      ...
      <div
        ...
        <NuxtLink
          ...
          class="board-summary"
          :to="
            organizationRoutes.board(pageState.data.SpacePage.key, board.id)
          ">
          <div class="summary-title">
...
import type { SpacePageDeps } from '~/sections/spaces/space/SpacePageDeps'
...
const boards = computed(() =>
  pageState.value.type === 'ready' ? pageState.value.data.SpacePage.boards : [],
)
