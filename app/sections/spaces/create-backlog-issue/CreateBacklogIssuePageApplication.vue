...
import type { CreateBacklogIssuePageApplicationDeps } from './CreateBacklogIssuePageApplicationDeps'
import CreateBacklogIssuePage from './view/CreateBacklogIssuePage.vue'

const props = defineProps<{
  deps: CreateBacklogIssuePageApplicationDeps
  spaceKey: string
}>()
...
const { refresh, state: pageState } = await useActionData({
  ...
  key: () => asyncDataKeys.space.createBacklogIssue(props.spaceKey),
  messages: {
