      ...
      <DragDropProvider
        ...
        <div class="column-settings">
          <BoardColumnSetting
            ...
            :index="index"
            :name="column.name"
            @delete="removeColumn(column.key)"
            @update-color="column.color = $event"
            @update-name="column.name = $event" />
        </div>
      </DragDropProvider>
      <button
...
import BoardColumnSetting from './components/BoardColumnSetting/BoardColumnSetting.vue'
